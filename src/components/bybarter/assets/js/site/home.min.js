...
$('#buy-search-btn').click(function() {
    var base_url = $('#base_url').val();
    var coin = $('#search-buy-coin').val();
    var type = $('#buy-type').val();
    var price = $('#buy-price').val();
    if (price < 0) Toast('Amount must be greater than 0.', 3000, 3);
    else window.location = base_url + '/buy-coins-list/?coin=' + coin + '&type=' + type + '&price=' + price;
});
$('#sell-search-btn').click(function() {
    var base_url = $('#base_url').val();
    var base_url = $('#base_url').val();
    var coin = $('#search-sell-coin').val();
    var type = $('#sell-type').val();
    var price = $('#sell-price').val();
    if (price < 0) Toast('Amount must be greater than 0.', 3000, 3);
    else window.location = base_url + '/sell-coins-list/?coin=' + coin + '&type=' + type + '&price=' + price;
});

$(document).on('keyup', '#buy-price', function() {
    var amount = this.value.toString();
    var index = amount.indexOf('.');
    if (index > 0) {
        amount = amount.substring(0, index + 3);
        $('#buy-price').val(amount);
    }
});
$(document).on('keyup', '#sell-price', function() {
    var amount = this.value.toString();
    var index = amount.indexOf('.');
    if (index > 0) {
        amount = amount.substring(0, index + 3);
        $('#sell-price').val(amount);
    }
});

function changecoin(coins, currency, price, img, currencyname) {
    $('.text1').html('');
    $('.text2').html('');
    $('.currencyname').html('');
    $('.paycurrency').html('');
    $('.paycurrency').html(currency);
    $('.imgwithtext').attr('src', '');
    $('.text1').html('1 ' + currencyname + ' = ');
    $('.text2').html(filter_number_format(price) + ' USD');
    $('.imgwithtext').attr('src', img);
    $('#buycoin').val(price);
    ...
    $('#price').val('');
    $('.textchanges').html('≈ ');
    $('.by_coin').removeClass('d-none');
    $('.hide_buy_coin' + coins).addClass('d-none');
    $('.ans').html('0 ' + $('#coin_symbol').val());
}

function paycoin(coins, currency, price, img, currencyname) {
    $('.paytext1').html('');
    $('.paytext2').html('');
    $('.paycurname').html('');
    $('.ans').html('');
    ...
    $('.payimage').attr('src', '');
    $('#coin_symbol').val('');
    $('.paytext1').html('1 ' + currencyname + ' = ');
    $('.paytext2').html(filter_number_format(price) + ' USD');
    $('.payimage').attr('src', img);
    $('#payvia').val(price);
    $('#coin_symbol').val(currency);
    $('.paycurname').html(currencyname);
    $('.textchanges').html('≈ ');
    $('.ans').html('0 ' + currency);
    $('#price').val('');
    $('#buysearch').val('');
...
function sellchangecoin(coins, currency, price, img, currencyname) {
    $('.text3').html('');
    $('.text4').html('');
    $('.sellcurrencyname').html('');
    $('.paycurrency').html('');
    $('.paycurrency').html(currency);
    $('.sellimgwithtext').attr('src', '');
    $('.text3').html('1 ' + currencyname + ' = ');
    $('.text4').html(filter_number_format(price) + ' USD');
    $('.sellimgwithtext').attr('src', img);
    $('#sellcoin').val(price);
    $('.sellcurrencyname').html(currencyname);
    $('#sellcoinid').val(coins);
    $('.sellpaycurrency').html(currency);
    $('#sellprice').val('');
    $('.textchanges').html('≈ ');
    $('.sell_coins').removeClass('d-none');
    $('.hide_sell_coin' + coins).addClass('d-none');
    $('.sellans').html('0 ' + $('#sellcoin_symbol').val());
}

function sellpaycoin(coins, currency, price, img, currencyname) {
    $('.paytext3').html('');
    $('.paytext4').html('');
    $('.sellpaycurrencyname').html('');
    $('.sellans').html('');
    $('.sellans').html(currency);
    $('.sellpayimage').attr('src', '');
    $('#sellcoin_symbol').val('');
    $('.paytext3').html('1 ' + currencyname + ' = ');
    $('.paytext4').html(filter_number_format(price) + ' USD');
    $('.sellpayimage').attr('src', img);
    $('#sellpayvia').val(price);
    $('#sellcoin_symbol').val(currency);
    $('.sellpaycurrencyname').html(currencyname);
    $('.textchanges').html('≈ ');
    $('.sellans').html('0 ' + currency);
    $('#sellprice').val('');
    $('#sellsearch').val('');
    $("#search_result1").addClass("d-none");
    $("#static1").removeClass("d-none");
    $('#sellpaycoinid').val(coins);
}

function changeTab(id) {
    var defaultcurency = $('#defaultcurency').val();
    var defaultcurencyprice = $('#defaultcurencyprice').val();
    var defaultcurency1 = $('#defaultcurency1').val();
    var defaultcurencyprice1 = $('#defaultcurencyprice1').val();
    var defaultcurencyimg = $('#defaultcurencyimg').val();
    var defaultcurencyimg1 = $('#defaultcurencyimg1').val();
    var defaultcurencysymbol = $('#defaultcurencysymbol').val();


    $('.text1').html('1 ' + defaultcurency + ' = ');
    $('.text2').html(filter_number_format(defaultcurencyprice) + ' USD');
    $('.text3').html('1 ' + defaultcurency + ' = ');
    $('.text4').html(filter_number_format(defaultcurencyprice) + ' USD');
    $('.paytext1').html('1 ' + defaultcurency1 + ' = ');
    $('.paytext2').html(filter_number_format(defaultcurencyprice1) + ' USD');
    $('.paytext3').html('1 ' + defaultcurency1 + ' = ');
    $('.paytext4').html(filter_number_format(defaultcurencyprice1) + ' USD');
    $('.imgwithtext').attr('src', defaultcurencyimg);
    $('.payimage').attr('src', defaultcurencyimg1);
    $('.currencyname').html(defaultcurency);
    $('.sellcurrencyname').html(defaultcurency);
    $('.paycurrency').html(defaultcurency);
    $('.sellpaycurrency').html(defaultcurency);
    $('.sellpaycurrencyname').html(defaultcurency1);
    $('.paycurname').html(defaultcurency1);
    $('.sellimgwithtext').attr('src', defaultcurencyimg);
    $('.sellpayimage').attr('src', defaultcurencyimg1);

    $('#extarnal_payments_accept').val('');
    $('#extarnal_payments_acceptsell').val('');

    if (id == 1) {
        $('#price').val("");
        $('.textchanges').html('≈ ');
        $('.ans').html('0 ' + defaultcurencysymbol);
    } else {
        $('#sellprice').val("");
        $('.selltextchanges').html('≈ ');
        $('.sellans').html('0 ' + defaultcurencysymbol);
    }
    $('#type').val(id);
}
...
function searchcoin(name) {
    ...
    if (coin_name != "") {
        postAjax(searchurl, {
            ...
            if (res.flag != 0) {
                if (res.data.length > 0) {
                    $("#search_result" + key).removeClass("d-none");
                    $("#static" + key).addClass("d-none");
                    $("#search_result" + key).html("");
                    $.each(res.data, function(index, value) {
                        var img = coin_img_path + "/" + value.currency_image;
                        var coin_id = value.id;
                        var coin_short_name = value.currency_symbol;
                        var price_in_usd = value.price_in_usd;

                        $("#search_result" + key).append(`
                        <a class="dropdown-item slider-dropdown-list by_coin hide_buy_coin` + coin_id + `"
                        onclick="` + fname + `('` + coin_id + `','` + coin_short_name + `','` + price_in_usd + `','` + img + `','` + coin_short_name + `')"
                        data-id="` + coin_id + `" data-coin-name="` + coin_short_name + `"
                        href="javascript:void(0);"><span class="coin-img">
                        <img src=` + img + ` alt="currency-img"></span>` + coin_short_name + `</a>`);
                    });
                } else {
                    $("#search_result" + key).removeClass("d-none");
                    $("#static" + key).addClass("d-none");
                    $("#search_result" + key).html("");
                    $("#search_result" + key).append(`<li class="no-coin text-center">Not record found</li>`);
                }
            } else {
                alert("error");
            }
        ...
        $("#search_result" + key).addClass("d-none");
        $("#static" + key).removeClass("d-none");
    }
}
$('#price').keyup(function(event) {
    if ($(this).val().length > 0) {
        $('.textchanges').html('');
        $('.textchanges').html('≈ ');
        var buycoin = $('#buycoin').val();
        var payvia = $('#payvia').val();
        var coin = $('#coin_symbol').val();
        console.log($(this).val());
        console.log(buycoin);
        console.log(payvia);
        var price = buycoin / payvia;
        var finalprice = price * $(this).val();
        $('.ans').html(parseFloat(finalprice).toLocaleString() + " " + coin);
    } else {
        $('.textchanges').html('');
        $('.ans').html('');
        $('.textchanges').html('≈ ');
...
$('#sellprice').keyup(function(event) {
    if ($(this).val().length > 0) {
        $('.selltextchanges').html('');
        $('.selltextchanges').html('≈ ');
        var buycoin = $('#sellcoin').val();
        var payvia = $('#sellpayvia').val();
        var coin = $('#sellcoin_symbol').val();
        console.log($(this).val());
        console.log(buycoin);
        console.log(payvia);
        var price = buycoin / payvia;
        var finalprice = price * $(this).val();
        $('.sellans').html(parseFloat(finalprice).toLocaleString() + " " + coin);
    } else {
        $('.selltextchanges').html('');
        $('.sellans').html('');
        $('.selltextchanges').html('Minimum ');
        $('.sellans').html('10 USD');
    }
...
$('#find_offer').click(function() {

    var payvia = $('#paycoinid').val();
    var type = $('#type').val();
    var buycoin = '';
    var quantity = '';
    var url = '';
    if (type == 1) {
        quantity = $('#price').val();
        buycoin = $('#buycoinid').val();
        if (quantity.length == 0) {
            Toast('Please Enter Quantity.', 3000, 0);
            return false;
        }
        url = 'buy-coins-list';
    } else {
        quantity = $('#sellprice').val();
        buycoin = $('#sellcoinid').val();
        if (quantity.length == 0) {
            Toast('Please Enter Quantity.', 3000, 0);
            return false;
        }
    ...
    // if(quantity < 10)
    // {
    //     Toast('Please Enter Minimum 10 Quantity.',3000,0); 
    //     return false;
    // }
    // window.location.href=base_url+"/"+url+'?coin='+buycoin+'&type='+type+'&quantity='+quantity;
    window.location.href = base_url + "/" + url + '?coin=' + buycoin;
...
$('#price').keypress(function(event) {
    ...
    if ((text.indexOf('.') != -1) && (text.substring(text.indexOf('.')).length > 8 && (event.which != 0 && event.which != 8 && ($(this)[0].selectionStart >= text.length - 8)))) {
        event.preventDefault();
    }
...
$('#price').bind("paste", function(e) {
    ...
    if ($.isNumeric(text)) {
        if ((text.substring(text.indexOf('.')).length > 8 && (text.indexOf('.') > -1))) {
            e.preventDefault();
            $(this).val(text.substring(0, text.indexOf('.') + 8));
        }
    } else {
        e.preventDefault();
    }
...
$('#sellprice').bind("paste", function(e) {
    var text = e.originalEvent.clipboardData.getData('Text');
    if ($.isNumeric(text)) {
        if ((text.substring(text.indexOf('.')).length > 8 && (text.indexOf('.') > -1))) {
            e.preventDefault();
...
function filter_number_format(value) {
    var vall = value;
...
function getPaymentMethods(id) {
    ...
    $.ajax({
        type: 'POST',
        url: payments_method_url,
        data: jdata,
        success: async function(res) {
            if (res.flag == 1) {
                $('#search').val('');
                $('#search_method').val(id);
                console.log('------------------------------------');
                console.log(res);
                console.log('------------------------------------');
                $('#method' + id).html('');
                $.each(res.data, function(index, value) {
                    if (id != 5) {
                        ...
                        if (value.payment_method == 1) {
                            svg = `<svg width="32" height="32" fill="none" viewBox="0 0 32 32" class="icon-24 mr-2 my-n1 icon-multicolor">
									<path fill="var(--icons-bg-fill, #ffffff)" d="M6 13h4v14H6zm8 0h4v14h-4zm8 0h4v14h-4z"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M5 12h6v16H5V12zm2 2v12h2V14H7zm14-2h6v16h-6V12zm2 2v12h2V14h-2zm-10-2h6v16h-6V12zm2 2v12h2V14h-2z" clip-rule="evenodd"></path>
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M2 29a3 3 0 013-3h22a3 3 0 013 3v1h-2v-1a1 1 0 00-1-1H5a1 1 0 00-1 1v1H2v-1zM14.226 2.061a3 3 0 013.548 0l11.354 8.326c1.559 1.143.75 3.613-1.183 3.613H4.055c-1.933 0-2.742-2.47-1.183-3.613l11.354-8.326zm2.365 1.613a1 1 0 00-1.182 0L4.055 12h23.89L16.591 3.674z" clip-rule="evenodd"></path>
								</svg>`
                        } else if (value.payment_method == 2) {
                            svg = `<svg width="32" height="32" fill="none" viewBox="0 0 32 32" class="icon-24 mr-2 my-n1 icon-multicolor">
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M5 8a3 3 0 00-3 3v16a3 3 0 003 3h20a3 3 0 003-3v-4h-2v4a1 1 0 01-1 1H5a1 1 0 01-1-1V14h21a1 1 0 011 1v4h2v-4a3 3 0 00-3-3v-1a3 3 0 00-3-3H5zm18 4v-1a1 1 0 00-1-1H5a1 1 0 00-1 1v1h19z" clip-rule="evenodd"></path>
									<path fill="var(--icons-secondary, #888888)" d="M4 20a1 1 0 110-2h4a1 1 0 110 2H4z"></path>
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M12 25.5a1 1 0 000-1.414l-1.207-1.207A3 3 0 008.672 22H4v2h4.672a1 1 0 01.707.293l1.207 1.207a1 1 0 001.414 0zm9-4.5a3 3 0 013-3h3a3 3 0 110 6h-3a3 3 0 01-3-3zm3-1a1 1 0 100 2h3a1 1 0 100-2h-3z" clip-rule="evenodd"></path>
									<path fill="var(--icons-bg-fill, #ffffff)" d="M7 4.286C7 3.576 7.895 3 9 3h9c1.105 0 2 .576 2 1.286V12H7V4.286z"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M9 2a3 3 0 00-3 3v7h2V5a1 1 0 011-1h9a1 1 0 011 1v7h2V5a3 3 0 00-3-3H9z" clip-rule="evenodd"></path>
									<rect width="2" height="5" x="14" y="6" fill="var(--icons-primary, #f3ba2f)" rx="1"></rect>
								</svg>`
                        } else if (value.payment_method == 3) {
                            svg = `<svg width="32" height="32" fill="none" viewBox="0 0 32 32" class="icon-24 mr-2 my-n1 icon-multicolor">
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M6 15a3 3 0 013-3h20a3 3 0 013 3v10a3 3 0 01-3 3H9a3 3 0 01-3-3V15zm3-1a1 1 0 00-1 1v10a1 1 0 001 1h20a1 1 0 001-1V15a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M16 21.154l1.002.58a2 2 0 100-3.467L16 18.845l-1.002-.58a2 2 0 100 3.467L16 21.155zm0-4.619a4 4 0 100 6.93 4 4 0 100-6.93z" clip-rule="evenodd"></path>
									<path fill="var(--icons-bg-fill, #ffffff)" d="M1 7a2 2 0 012-2h20a2 2 0 012 2v10a2 2 0 01-2 2H3a2 2 0 01-2-2V7z"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M0 7a3 3 0 013-3h20a3 3 0 013 3v10a3 3 0 01-3 3H3a3 3 0 01-3-3V7zm3-1a1 1 0 00-1 1v10a1 1 0 001 1h20a1 1 0 001-1V7a1 1 0 00-1-1H3z" clip-rule="evenodd"></path>
									<path fill="var(--icons-bg-fill, #ffffff)" fill-rule="evenodd" d="M10 15.465a4 4 0 110-6.93 4 4 0 110 6.93z" clip-rule="evenodd"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M10 13.154l1.002.58a2 2 0 100-3.467L10 10.845l-1.002-.58a2 2 0 100 3.467L10 13.155zm0-4.619a4 4 0 100 6.93 4 4 0 100-6.93z" clip-rule="evenodd"></path>
								</svg>`
                        } else if (value.payment_method == 4) {
                            svg = `<svg width="32" height="32" fill="none" viewBox="0 0 32 32" class="icon-24 mr-2 my-n1 icon-multicolor">
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M6 7a3 3 0 013-3h20a3 3 0 013 3v10a3 3 0 01-3 3H9a3 3 0 01-3-3V7zm3-1a1 1 0 00-1 1v10a1 1 0 001 1h20a1 1 0 001-1V7a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M17.333 9.333a.667.667 0 100 1.334.667.667 0 000-1.334zm-2 .667a2 2 0 114 0 2 2 0 01-4 0zm7.334 3.333a.667.667 0 100 1.334.667.667 0 000-1.334zm-2 .667a2 2 0 114 0 2 2 0 01-4 0z" clip-rule="evenodd"></path>
									<path fill="var(--icons-secondary, #888888)" d="M21.852 9.138a.667.667 0 01.943.943l-4.714 4.714a.667.667 0 01-.943-.943l4.714-4.714z"></path>
									<path fill="var(--icons-bg-fill, #ffffff)" d="M.667 14.667a2 2 0 012-2h20a2 2 0 012 2v10.666a2 2 0 01-2 2h-20a2 2 0 01-2-2V14.667z"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M0 15a3 3 0 013-3h20a3 3 0 013 3v10a3 3 0 01-3 3H3a3 3 0 01-3-3V15zm3-1a1 1 0 00-1 1v10a1 1 0 001 1h20a1 1 0 001-1V15a1 1 0 00-1-1H3z" clip-rule="evenodd"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M10.667 17.333a.667.667 0 100 1.334.667.667 0 000-1.334zm-2 .667a2 2 0 114 0 2 2 0 01-4 0zM16 21.333a.667.667 0 100 1.334.667.667 0 000-1.334zM14 22a2 2 0 114 0 2 2 0 01-4 0z" clip-rule="evenodd"></path>
									<path fill="var(--icons-primary, #f3ba2f)" d="M15.185 17.138a.667.667 0 01.943.943l-4.714 4.714a.667.667 0 01-.943-.943l4.714-4.714z"></path>
								</svg>`
                        } else if (value.payment_method == 6) {
                            svg = `<svg width="32" height="32" fill="none" viewBox="0 0 32 32" class="icon-24 mr-2 my-n1 icon-multicolor">
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M6 16a3 3 0 013-3h20a3 3 0 013 3v10a3 3 0 01-3 3H9a3 3 0 01-3-3V16zm3-1a1 1 0 00-1 1v10a1 1 0 001 1h20a1 1 0 001-1V16a1 1 0 00-1-1H9z" clip-rule="evenodd"></path>
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M19 23a2 2 0 100-4 2 2 0 000 4zm0 2a4 4 0 100-8 4 4 0 000 8z" clip-rule="evenodd"></path>
									<path fill="var(--icons-bg-fill, #ffffff)" d="M1 6a2 2 0 012-2h20a2 2 0 012 2v10a2 2 0 01-2 2H3a2 2 0 01-2-2V6z"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M0 6a3 3 0 013-3h20a3 3 0 013 3v10a3 3 0 01-3 3H3a3 3 0 01-3-3V6zm3-1a1 1 0 00-1 1v10a1 1 0 001 1h20a1 1 0 001-1V6a1 1 0 00-1-1H3z" clip-rule="evenodd"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M13 13a2 2 0 100-4 2 2 0 000 4zm0 2a4 4 0 100-8 4 4 0 000 8z" clip-rule="evenodd"></path>
								</svg>`
                        } else if (value.payment_method == 7) {
                            svg = `<svg width="32" height="32" fill="none" viewBox="0 0 32 32" class="icon-24 mr-2 my-n1 icon-multicolor">
									<path fill="var(--icons-secondary, #888888)" fill-rule="evenodd" d="M4 13h24v15h2v2H2v-2h2V13zm22 2v13H15V18H8v10H6V15h20zm-13 5v8h-3v-8h3zm8-2a3 3 0 00-3 3v3h6v-3a3 3 0 00-3-3zm1 4h-2v-1a1 1 0 112 0v1z" clip-rule="evenodd"></path>
									<path fill="var(--icons-bg-fill, #ffffff)" fill-rule="evenodd" d="M5.904 3.9A3 3 0 018.695 2h14.61a3 3 0 012.791 1.9l3.296 8.367A2 2 0 0127.532 15H4.468a2 2 0 01-1.861-2.733L5.904 3.9z" clip-rule="evenodd"></path>
									<path fill="var(--icons-primary, #f3ba2f)" fill-rule="evenodd" d="M8.695 2a3 3 0 00-2.791 1.9l-3.296 8.367A2 2 0 004.468 15h23.063a2 2 0 001.861-2.733L26.096 3.9A3 3 0 0023.305 2H8.695zm-.93 2.633A1 1 0 018.695 4h14.61a1 1 0 01.93.633L27.531 13H4.47l.788-2H14a1 1 0 100-2H6.044l1.72-4.367z" clip-rule="evenodd"></path>
								</svg>`
                        }
                        $('#method' + id).append(`
							<div class="gethtml">
								<button type="button" class="payment-method-item payments-` + value.id + `" data-id="` + value.id + `" data-payment-id="` + value.payment_method + `">
									<span>
									` + svg + `
									<span class="text-truncate" title="` + value.payment_name + `">` + value.payment_name + `</span>
									</span>
								</button>			
							</div>
						`);
...
function searchpayments(val) {
    ...
    $.ajax({
        type: 'POST',
        url: payments_method_search_url,
        data: jdata,
        success: async function(res) {
            ...
            if (res.flag == 1) {
                $('#method' + id).html('');
                if (res.data.length > 0) {
                    $('.search-result' + id).removeClass('d-none');
                    $('.search-not-found' + id).addClass('d-none');
                    $('#search_method').val(id);
                    $.each(res.data, function(index, value) {
                        if (id != 5) {
                            var svg;
                    ...
                    console.log('else');
                    console.log('------------------------------------');
                    $('.search-result' + id).addClass('d-none');
                    $('.search-not-found' + id).removeClass('d-none');
                    $('#notfound' + id).html(`
								<h1>No Data Found</h1>			
							`);
                }
